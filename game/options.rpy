...
define gui.about = _p("""Дебург - маленький город, в котором живут обычные люди. Здесь вас познакомят с выпускницей института культуры по имени Мэри, а также ты познакомишься с её друзьями. Но всё ли у них так обычно, как у других?
                      Важен Ваш выбор: он влияет на историю и возможно... Вы даже откроете то, что не следовало бы... В дальнейших обновлениях будет больше контента!
""")
